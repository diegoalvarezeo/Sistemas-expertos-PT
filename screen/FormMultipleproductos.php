...
<body>
    ...
    ?>
    <div class="row">
            <!--Formulario Productos Multiples  -->
            <form method="POST" class="col-6" action="">
                
                <div class=" border m-4 p-4">
                    <div class="mb-5">
                        <label for="numero" class="form-label">Ingrese Cantidad de Este Producto</label>
                        <input type="number" class="form-control" id="numero" name="numero" placeholder="Número de productos">
                    </div>  
                    ...
                    <button type="submit" name="btningresarMp" class="btn btn-primary  mt-2" value="ok">Enviar</button>    
                </div>
